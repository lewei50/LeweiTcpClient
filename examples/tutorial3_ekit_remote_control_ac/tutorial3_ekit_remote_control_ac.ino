...
//see comment#1 at the bottom of the code
...
void closeAc(char* p1)
{
  ...
  client->checkFreeMem();
  irsend.sendRaw(rawCodes_ac_close,1, 38);   // 记得换成你遥控器的红外线编码
}
*/

/*
//comment #1
because of the lack of the ram on UNO is only 2k,
we can't control AC both open and close at the same time,
it takes 400Bytes RAM when define the array with its size is 200Byte.
UNO can't afford this.
if your raw codes is less shorter,then you can try it yourself.
Enjoy it.
*/
